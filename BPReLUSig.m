function [TrainNetworkOut,TestNetworkOut,ErrHistory] = BPReLUSig(TrainIn,TrainOut,TestIn,W1,B1,W2,B2,HiddenUnitNum,MaxEpochs,lr,E0,L,num_class,pL)
...
for i=1:MaxEpochs
    ...
    HiddenOut=InToHidden .* (InToHidden>0);
