function [TrainNetworkOut,TestNetworkOut,ErrHistory] = BPLogsig(TrainIn,TrainOut,TestIn,W1,B1,W2,B2,HiddenUnitNum,MaxEpochs,lr,E0,L,num_class,pL)
...
for i=1:MaxEpochs
    HiddenOut=logsig(W1Ex*TrainInEx);
...
TrainHiddenOut=logsig(W1*TrainIn+repmat(B1,1,TrainNum));
TrainNetworkOut=logsig(W2*TrainHiddenOut+repmat(B2,1,TrainNum));

%%%%%%%%%%%%%%%%%%%%%%%%% calculate the test error  %%%%%%%%%%%%%%%%%%%%%%%%%
TestHiddenOut=logsig(W1*TestIn+repmat(B1,1,TestNum));
