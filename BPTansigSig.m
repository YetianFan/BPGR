function [TrainNetworkOut,TestNetworkOut,ErrHistory] = BPTansigSig(TrainIn,TrainOut,TestIn,W1,B1,W2,B2,HiddenUnitNum,MaxEpochs,lr,E0,L,num_class,pL)
...
for i=1:MaxEpochs
    HiddenOut=tansig(W1Ex*TrainInEx);
    ...
    Delta1=W2'*Delta2.*(1-HiddenOut.*HiddenOut);
...
TrainHiddenOut=tansig(W1*TrainIn+repmat(B1,1,TrainNum));
TrainNetworkOut=logsig(W2*TrainHiddenOut+repmat(B2,1,TrainNum));

%%%%%%%%%%%%%%%%%%%%%%%%% calculate the test error  %%%%%%%%%%%%%%%%%%%%%%%%%
TestHiddenOut=tansig(W1*TestIn+repmat(B1,1,TestNum));
